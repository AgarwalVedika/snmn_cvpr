...
# --------------------------------------------------------------------------- #
__C.TRAIN = AttrDict()
__C.TRAIN.SPLIT_VQA =  'trainval2014'                   #####originally 'trainval2014'
...
__C.TRAIN.DROPOUT_KEEP_PROB = 0.85                     # original 0.85
...
__C.TRAIN.CLIP_GRADIENTS = False
...
__C.TRAIN.SNAPSHOT_INTERVAL = 2500
__C.TRAIN.INIT_FROM_WEIGHTS = False
__C.TRAIN.INIT_WEIGHTS_FILE = ''
__C.TRAIN.MAX_ITER = 80000            #originally 80000
...
__C.TRAIN.NUM_VIS = 200
__C.TRAIN.NUM_VIS_CORRECT = 100
__C.TRAIN.NUM_VIS_INCORRECT = 100
__C.TRAIN.VIS_DIR_PREFIX = 'vis_train'
__C.TRAIN.STEPWISE_VIS = True  # Use the (new) stepwise visualization
__C.TRAIN.VIS_SHOW_ANSWER = True
__C.TRAIN.VIS_SHOW_STACK = True
__C.TRAIN.VIS_SHOW_IMG = True
__C.TRAIN.EVAL_FILE = './exp_vqa/eval_outputs/%s/train.pickle'
# --------------------------------------------------------------------------- #
# val options
# --------------------------------------------------------------------------- #
__C.VAL = AttrDict()
__C.VAL.SPLIT_VQA = 'val2014'
__C.VAL.EVAL_FILE = './exp_vqa/eval_outputs/%s/val.pickle'
# --------------------------------------------------------------------------- #
# test options
# --------------------------------------------------------------------------- #
__C.TEST = AttrDict()
...
__C.TEST.SPLIT_VQA = 'val2014'           # originally 'test-dev2015' #     ###checking for vlaidation accuracies- visualize using tensorboard
...
__C.TEST.ITER_10_10 = -1  # Needs to be supplied
...
__C.TEST.EVAL_FILE_npy = './exp_vqa/eval_outputs/%s/vqa_%s_%s_%s_results.npy'
__C.TEST.EVAL_FILE_pkl = './exp_vqa/eval_outputs/%s/old_style_vqa_%s_%s_%s_results.pickle'
__C.TEST.VIS_SEPARATE_CORRECTNESS = True
__C.TEST.NUM_VIS = 100
__C.TEST.NUM_VIS_CORRECT = 50
__C.TEST.NUM_VIS_INCORRECT = 50
__C.TEST.VIS_DIR_PREFIX = 'vis_test'
__C.TEST.STEPWISE_VIS = True  # Use the (new) stepwise visualization
__C.TEST.VIS_SHOW_ANSWER = True
__C.TEST.VIS_SHOW_GT_ANSWER = True              # False for 'test2015' or 'test-dev2015'
