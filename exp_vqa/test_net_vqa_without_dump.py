...
print()
print('\n exp: %s, epoch = %d, final accuracy on %s = %f (%d / %d)' %
      (cfg.EXP_NAME, cfg.TEST.ITER, cfg.TEST.SPLIT_VQA,    ###TEST.ITER here is same as TEST.EPOCH: goes from 1 to 20
       round(accuracy,4), answer_correct, num_questions))
