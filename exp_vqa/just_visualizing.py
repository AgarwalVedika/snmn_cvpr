...
#     assert(answer_word_list[0] == '<unk>')                                     ####### unk asserted here
#     output_qids_answers = []
...
snapshot_file = cfg.TEST.SNAPSHOT_FILE % (cfg.EXP_NAME, cfg.TEST.ITER) ####they ar eloading the snapshot here- chose the one that does the best instead of the end one  ##comment_vedika
