...
__C.TRAIN.NUM_SAMPLES  = 10000                            #CHANGE THIS EVERYTIME NOW!!!!!! OR like GPU ID- you would be able to specify it all time
__C.TRAIN.USE_GT_LAYOUT = True
__C.TRAIN.WEIGHT_DECAY = 1e-5
__C.TRAIN.DROPOUT_KEEP_PROB = 0.85                         # dropout parameter- vary from 0.5 to 0.9 in steps of 0.1
