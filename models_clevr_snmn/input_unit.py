...
def build_input_unit(input_seq_batch, seq_length_batch, num_vocab,
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        #print('lstm_seq:', lstm_seq)   #embed_seq Tensor("model/input_unit/embedding_lookup:0", shape=(?, ?, 300), dtype=float32) ; lstm_seq: Tensor("model/input_unit/concat:0", shape=(?, ?, 512), dtype=float32)
